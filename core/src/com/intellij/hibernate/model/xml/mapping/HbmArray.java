...
/**
 * hibernate-mapping-3.0.dtd:array interface.
 */
public interface HbmArray extends CommonDomModelElement, HbmContainer {
	...
	/**
	 * Returns the value of the element-class child.
	 * Attribute element-class
	 * @return the value of the element-class child.
	 */
	@NotNull
	GenericAttributeValue<String> getElementClass();
