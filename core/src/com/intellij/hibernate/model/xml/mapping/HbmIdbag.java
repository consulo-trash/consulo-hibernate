...
/**
 * hibernate-mapping-3.0.dtd:idbag interface.
 */
public interface HbmIdbag extends CommonDomModelElement, HbmContainer {
	...
	/**
	 * Returns the value of the collection-id child.
	 * Type collection-id documentation
	 * <pre>
	 * - default: Hibernate.CLASS 
	 * </pre>
	 * @return the value of the collection-id child.
	 */
	@NotNull
	@Required
	HbmCollectionId getCollectionId();
