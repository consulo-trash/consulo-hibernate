...
/**
 * hibernate-mapping-3.0.dtd:map interface.
 ...
 * </pre>
 */
public interface HbmMap extends CommonDomModelElement, HbmContainer {
	...
	/**
	 * Returns the value of the composite-map-key child.
	 * Type composite-map-key documentation
	 * <pre>
	 *  Composite index of a map ie. a map keyed on components. 
	 * </pre>
	 * @return the value of the composite-map-key child.
	 */
	@NotNull
	HbmCompositeMapKey getCompositeMapKey();


	/**
	 * Returns the value of the map-key-many-to-many child.
	 * Type map-key-many-to-many documentation
	 * <pre>
	 *  Many to many association mapped to the key of a map. ie. a map keyed
	 * on entities. 
	 * </pre>
	 * @return the value of the map-key-many-to-many child.
	 */
	@NotNull
	HbmMapKeyManyToMany getMapKeyManyToMany();
	...
	/**
	 * Returns the value of the composite-index child.
	 * @return the value of the composite-index child.
	 */
	@NotNull
	HbmCompositeIndex getCompositeIndex();


	/**
	 * Returns the value of the index-many-to-many child.
	 * @return the value of the index-many-to-many child.
	 */
	@NotNull
	HbmIndexManyToMany getIndexManyToMany();


	/**
	 * Returns the value of the index-many-to-any child.
	 * Type index-many-to-any documentation
	 * <pre>
	 * - default: Hibernate.CLASS 
	 * </pre>
	 * @return the value of the index-many-to-any child.
	 */
	@NotNull
	HbmIndexManyToAny getIndexManyToAny();
