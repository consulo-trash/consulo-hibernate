...
public interface PersistenceUnitManipulator<T extends PersistencePackage> extends PersistenceManipulator<T> {
  void ensureMappingIncluded(final PersistenceMappings mappings);
  void ensureClassIncluded(final PsiClass psiClass);
  void setConnectionProperties(final DatabaseConnectionInfo info);
}