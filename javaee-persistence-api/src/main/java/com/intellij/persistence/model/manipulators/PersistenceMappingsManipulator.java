...
public interface PersistenceMappingsManipulator<T extends PersistenceMappings> extends PersistenceManipulator<T> {
  PersistentEntity addEntity(final PsiDirectory directory, final PersistencePackage unit, final String shortClassName, final String entityName) throws IncorrectOperationException;
