...
public class HibernateFacet extends PersistenceFacetBase<HibernateFacetConfiguration, PersistencePackage> {
  ...
  public HibernateFacet(@Nonnull final FacetType<HibernateFacet, HibernateFacetConfiguration> facetType, @Nonnull final Module module,
                        final String name, @Nonnull final HibernateFacetConfiguration configuration, Facet underlyingFacet) {
