...
public class HibernateFrameworkSupportProvider extends FacetBasedFrameworkSupportProvider<HibernateFacet> {
  ...
  @Nonnull
  public FrameworkSupportConfigurableBase createConfigurable(final @Nonnull FrameworkSupportModel model) {
  ...
  private class HibernateConfigurable extends FrameworkSupportConfigurableBase {
    ...
    public void addSupport(@Nonnull final Module module, @Nonnull final ModifiableRootModel rootModel, final @Nullable Library library) {
